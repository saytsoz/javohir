                        ...
                        <div class="vertical-menu mb-all-30">
                            <nav>
                                <ul class="vertical-menu-list">
                                    <li class=""><a href="shop.html"><span><img src="/images/vertical-menu/1.png" alt="menu-icon"></span>Automotive & Motorcycle<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                    ...
                                    <li><a href="shop.html"><span><img src="/images/vertical-menu/3.png" alt="menu-icon"></span>Sports & Outdoors<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                        ...
                                        <ul class="ht-dropdown megamenu first-megamenu">
                                            ...
                                            <li class="megamenu-img">
                                                <a href="shop.html"><img src="/images/vertical-menu/sub-img1.jpg" alt="menu-image"></a>
                                                <a href="shop.html"><img src="/images/vertical-menu/sub-img2.jpg" alt="menu-image"></a>
                                                <a href="shop.html"><img src="/images/vertical-menu/sub-img3.jpg" alt="menu-image"></a>
                                            </li>
                                            <!-- Single Megamenu Image End -->
                                        </ul>
                                        <!-- Vertical Mega-Menu End -->
                                    </li>
                                    <li><a href="shop.html"><span><img src="/images/vertical-menu/6.png" alt="menu-icon"></span>Fashion<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                        <!-- Vertical Mega-Menu Start -->
                                    ...
                                    <li><a href="shop.html"><span><img src="/images/vertical-menu/7.png" alt="menu-icon"></span>Home & Kitchen<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                        <!-- Vertical Mega-Menu Start -->
                                        <ul class="ht-dropdown megamenu megamenu-two">
                                            <!-- Single Column Start -->
                                            <li class="single-megamenu">
                                    ...
                                    <li><a href="shop.html"><span><img src="/images/vertical-menu/4.png" alt="menu-icon"></span>Phones & Tablets<i class="fa fa-angle-right" aria-hidden="true"></i>
                                    </a>
                                        <!-- Vertical Mega-Menu Start -->
                                        <ul class="ht-dropdown megamenu megamenu-two">
                                            <!-- Single Column Start -->
                                    ...
                                    <li><a href="shop.html"><span><img src="/images/vertical-menu/6.png" alt="menu-icon"></span>TV & Video<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                        <!-- Vertical Mega-Menu Start -->
                                        <ul class="ht-dropdown megamenu megamenu-two">
                                            <!-- Single Column Start -->
                                            <li class="single-megamenu">
                                     ...
                                     <li><a href="shop.html"><span><img src="/images/vertical-menu/5.png" alt="menu-icon"></span>Beauty</a>
                                    </li>
                                    <li><a href="shop.html"><span><img src="/images/vertical-menu/8.png" alt="menu-icon"></span>Fruits & Veggies</a></li>
                                    <li><a href="shop.html"><span><img src="/images/vertical-menu/9.png" alt="menu-icon"></span>Computer & Laptop</a></li>
                                    <li><a href="shop.html"><span><img src="/images/vertical-menu/10.png" alt="menu-icon"></span>Meat & Seafood</a></li>
                                    <!-- More Categoies Start -->
                                    <li id="cate-toggle" class="category-menu v-cat-menu">
                                        <ul>
                                            <li class="has-sub"><a href="#">More Categories</a>
                                                <ul class="category-sub">
                                                    <li><a href="shop.html"><span><img src="/images/vertical-menu/11.png" alt="menu-icon"></span>Accessories</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 mb-all-40">
                            ...
                            <div class="tab-content">
                                <div id="thumb1" class="tab-pane fade show active">
                                    <a data-fancybox="images" href="/uploads/pages/<?=$product->image1?>"><img src="/uploads/pages/<?=$product->image1?>" alt="product-view"></a>
                                </div>
                                <div id="thumb2" class="tab-pane fade">
                                    <a data-fancybox="images" href="/uploads/pages/<?=$product->image2?>"><img src="/uploads/pages/<?=$product->image2?>" alt="product-view"></a>
                                </div>
                                <div id="thumb3" class="tab-pane fade">
                                    <a data-fancybox="images" href="/uploads/pages/<?=$product->image3?>"><img src="/uploads/pages/<?=$product->image3?>" alt="product-view"></a>
                                </div>
                                <div id="thumb4" class="tab-pane fade">
                                    <a data-fancybox="images" href="/uploads/pages/<?=$product->image4?>"><img src="/uploads/pages/<?=$product->image4?>" alt="product-view"></a>
                                </div>
                            ...
                            <div class="product-thumbnail mt-15">
                                <div class="thumb-menu owl-carousel nav tabs-area" role="tablist">
                                    <a class="active" data-toggle="tab" href="#thumb1"><img src="/uploads/pages/<?=$product->image1?>" alt="product-thumbnail"></a>
                                    <a data-toggle="tab" href="#thumb2"><img src="/uploads/pages/<?=$product->image2?>" alt="product-thumbnail"></a>
                                    <a data-toggle="tab" href="#thumb3"><img src="/uploads/pages/<?=$product->image3?>" alt="product-thumbnail"></a>
                                    <a data-toggle="tab" href="#thumb4"><img src="/uploads/pages/<?=$product->image4?>" alt="product-thumbnail"></a>
                        ...
                        <div class="col-lg-7">
                            <div class="thubnail-desc fix">
                                <h3 class="product-header"><?=$product->newtitle?></h3>
                                ...
                                <div class="pro-price mtb-30">
                                    <p class="d-flex align-items-center"><span class="prev-price">16.51</span><span class="price">$<?=$product->price?></span><span class="saving-price">save 8%</span></p>
                                </div>
               ...
               <!-- Product Title End -->
                ...
                <div class="hot-deal-active owl-carousel">
                    ...
                    <div class="single-product">
                        ...
                        <div class="pro-img">
                            <a href="product.html">
                                <img class="primary-img" src="/uploads/pages/<?= $item->image1?>" alt="single-product">
                                <img class="secondary-img" src="/uploads/pages/<?= $item->image2?>" alt="single-product">
                            </a>
