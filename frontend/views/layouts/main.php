    ...
    <div class="wrapper">
        ...
        <div class="popup_banner">
            ...
            <div class="banner_popup_area">
                    <img src="/images/banner/pop-banner.jpg" alt="">
            </div>
        </div>
        <!-- Banner Popup End -->
            ...
            <div class="test">
                ...
                <div class="subscribe_area text-center mt-60">
                    ...
                    <div class="subscribe-bottom mt-15">
                        ...
                        <label for="newsletter-permission">Don't show this popup </label>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <ul>                                          
                            <li><span>Language</span> <a href="#">English<i class="lnr lnr-chevron-down"></i></a>
                                ...
                                <ul class="ht-dropdown">
                                    <li><a href="#"><img src="/images/header/1.jpg" alt="language-selector">English</a></li>
                                    <li><a href="#"><img src="/images/header/2.jpg" alt="language-selector">Francis</a></li>
                                </ul>
                                <!-- Dropdown End -->
                            </li>
                                        ...
                                        <ul class="ht-dropdown cart-box-width">
                                            <li>
                                                ...
                                                <div class="single-cart-box">
                                                    <div class="cart-img">
                                                        <a href="#"><img src="/images/products/1.jpg" alt="cart-image"></a>
                                                ...
                                                <div class="single-cart-box">
                                                    <div class="cart-img">
                                                        <a href="#"><img src="/images/products/2.jpg" alt="cart-image"></a>
                                                        <span class="pro-quantity">1X</span>
                                                    </div>
                                                    <div class="cart-content">
                            ...
                            <div class="single-footer mb-sm-40">
                                ...
                                <div class="footer-content">
                                    ...
                                    <div class="payment mt-25 bdr-top pt-30">
                                        <a href="#"><img class="img" src="/images/payment/1.png" alt="payment-image"></a>
                                    </div>                                   
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="footer-middle-content pt-20 pb-30">
                            <ul class="social-footer">
                                ...
                                <li><a href="#"><img src="/images/icon/social-img1.png" alt="google play"></a></li>
                                <li><a href="#"><img src="/images/icon/social-img2.png" alt="app store"></a></li>
                            </ul>
                    </div>
                </div>
                <!-- Container End -->
                                    ...
                                    <div class="col-lg-5 col-md-6 col-sm-5">
                                        ...
                                        <div class="tab-content">
                                            <div id="thumb1" class="tab-pane fade show active">
                                                <a data-fancybox="images" href="img/products/35.jpg"><img src="/images/products/35.jpg" alt="product-view"></a>
                                            </div>
                                            <div id="thumb2" class="tab-pane fade">
                                                <a data-fancybox="images" href="img/products/13.jpg"><img src="/images/products/13.jpg" alt="product-view"></a>
                                            </div>
                                            <div id="thumb3" class="tab-pane fade">
                                                <a data-fancybox="images" href="img/products/15.jpg"><img src="/images/products/15.jpg" alt="product-view"></a>
                                            </div>
                                            <div id="thumb4" class="tab-pane fade">
                                                <a data-fancybox="images" href="img/products/4.jpg"><img src="/images/products/4.jpg" alt="product-view"></a>
                                            </div>
                                            <div id="thumb5" class="tab-pane fade">
                                                <a data-fancybox="images" href="img/products/5.jpg"><img src="/images/products/5.jpg" alt="product-view"></a>
                                            </div>
                                        </div>
